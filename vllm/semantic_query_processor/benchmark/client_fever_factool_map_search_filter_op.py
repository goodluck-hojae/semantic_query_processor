...
DEFAULT_CASCADE_LOW_THRESHOLD = 0.7
DEFAULT_CASCADE_HIGH_THRESHOLD = 0.9

DATA_ROOT = Path(__file__).resolve().parent / "sample_data"
DEFAULT_FEVER_CLAIMS_CSV = DATA_ROOT / "fever_claims_sample_1000_data.csv"
...
if __name__ == "__main__":
    ...
    cascade_low_threshold = float(os.environ.get(
        "FEVER_CASCADE_LOW_THRESHOLD",
        str(DEFAULT_CASCADE_LOW_THRESHOLD),
    ))
    cascade_high_threshold = float(os.environ.get(
        "FEVER_CASCADE_HIGH_THRESHOLD",
        str(DEFAULT_CASCADE_HIGH_THRESHOLD),
    ))
    ...
    query = (
        ...
        .sem_filter(
            ...
            cascade_max_tokens=cascade_max_tokens,
            cascade_low_threshold=cascade_low_threshold,
            cascade_high_threshold=cascade_high_threshold,
        )
    )
